...
import { JoinAuroraConcert } from "../feature/action/join-aurora-concert";
import { MediaOnlyForum } from "../feature/action/media-only-forum";
import { PauseAuroraPlaylist } from "../feature/action/pause-aurora-playlist";
import { PlayAuroraPlaylist } from "../feature/action/play-aurora-playlist";
...
featureMap.set(featureEnum.JoinAuroraConcert, JoinAuroraConcert);
featureMap.set(featureEnum.MediaOnlyForum, MediaOnlyForum);
featureMap.set(featureEnum.PauseAuroraPlaylist, PauseAuroraPlaylist);
featureMap.set(featureEnum.PlayAuroraPlaylist, PlayAuroraPlaylist);
